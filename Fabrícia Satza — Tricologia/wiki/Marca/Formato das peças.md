...
**Padrão: 3:4, 1080×1440.** Exportado em 2160×2880.

```
--peca-larg:1080px;  --peca-alt:1440px;   /* 3:4  padrão */
...
Sempre **imagens separadas**, uma por slide, numeradas na ordem. O botão de ZIP
serve no computador; no celular o navegador não descompacta e salva tudo junto
como PDF.
