...
- **Queda x quebra** — não é a mesma coisa e o tratamento é outro
- **O que a tricoscopia vê que o olho não vê**
- **Pós-parto** — o eflúvio que quase toda mulher tem e quase ninguém explica
- **Alopecia de tração** — a que vem do penteado, e é evitável
...
- Sobre por que encaminhar não é perder a paciente
- Sobre o tempo que o cabelo leva — e a ansiedade de quem espera

## Ideias de formato ainda não feitas

- **Carrossel de mito × fato** usando o bloco comparativo
- **Dado único** — um número por post, tipo "100 fios por dia é fisiológico"
- **Bastidores** — a rotina entre cirurgias, que você mencionou no CTA
