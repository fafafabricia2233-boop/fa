...
const PECA = {
  ...
  video: "newhair/conhecimentotecnico_h264.mp4",
...
const TITULO = {
  ...
  seguraAte: 2.7, // corte aos 2.90s
  saiEm: 2.9, // saída sobre o corte
};
...
const CUES: Cue[] = [
  {
    ...
    lines: [{ text: "COURO CABELUDO.", size: 44, gold: true }],
  },
  {
    start: 4.2,
    end: 4.9,
    lines: [{ text: "FIO.", size: 48, gold: true }],
  },
  {
    start: 5.6,
    end: 6.6,
    lines: [{ text: "FOLÍCULO.", size: 46, gold: true }],
  },
  {
    start: 6.6,
    end: 7.4,
    lines: [{ text: "QUEDA CAPILAR.", size: 44, gold: true }],
  },
  {
    start: 7.7,
    end: 10.5,
    lines: [
      { text: "Na New Hair, a gente acredita", size: 32 },
      { text: "que INSTRUMENTAÇÃO também exige", size: 40, gold: true },
    ],
  },
  {
    start: 10.7,
    end: 13.7,
    lines: [{ text: "CONHECIMENTO além da pinça.", size: 44, gold: true }],
  },
];
...
export type NewHairConhecimentoTecnicoProps = {
  durationSeconds: number;
  video: string;
};

export const NewHairConhecimentoTecnico: React.FC<NewHairConhecimentoTecnicoProps> = ({ video }) => {
