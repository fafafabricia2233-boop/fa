...
const PECA = {
  ...
  video: "newhair/etapaproxima_h264.mp4",
...
const TITULO = {
  ...
  seguraAte: 4.0, // sem cortes cedo (primeiro so aos 8.45s) — segura mais
  saiEm: 4.3,
};
...
const CUES: Cue[] = [
  {
    ...
    lines: [
      { text: "Não adianta SEPARAR BEM", size: 36, gold: true },
      { text: "se a implantação não acompanha.", size: 30 },
    ],
  },
  {
    start: 8.8,
    ...
    lines: [
      { text: "Na New Hair, cada etapa", size: 32 },
      { text: "CONVERSA com a próxima.", size: 40, gold: true },
    ],
  },
];
...
export type NewHairEtapaProximaProps = {
  durationSeconds: number;
  video: string;
};

export const NewHairEtapaProxima: React.FC<NewHairEtapaProximaProps> = ({ video }) => {
