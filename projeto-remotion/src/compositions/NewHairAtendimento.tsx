...
const PECA = {
  ...
  video: "newhair/tecnica_h264.mp4",
...
const TITULO = {
  ...
  seguraAte: 1.6, // corte aos 1.85s
  saiEm: 1.8, // saída sobre o corte
};
...
const CUES: Cue[] = [
  {
    ...
    lines: [{ text: "Como sua equipe TRATA o paciente?", size: 46, gold: true }],
  },
  {
    start: 4.0,
    end: 5.6,
    lines: [{ text: "Uma resposta ATRAVESSADA", size: 46, gold: true }],
  },
  {
    start: 5.8,
    end: 7.6,
    lines: [
      { text: "FALTA de atenção", size: 46, gold: true },
      { text: "e acolhimento", size: 34 },
    ],
  },
  {
    start: 8.2,
...
export type NewHairAtendimentoProps = {
  durationSeconds: number;
  video: string;
};

export const NewHairAtendimento: React.FC<NewHairAtendimentoProps> = ({ video }) => {
