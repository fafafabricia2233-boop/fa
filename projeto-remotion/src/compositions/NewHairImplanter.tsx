/* =============================================================================
   ...
   1. Copie este arquivo em src/compositions/ com o nome da peca.
      Ex.: NewHairGelox.tsx
   2. Troque NewHairImplanter por NewHairGelox nas 3 ocorrencias do fim do arquivo
...
const PECA = {
  ...
  video: "newhair/implanter_h264.mp4",
  ...
  endCard: 11.70 as number | null,   /* MEDIDO nesta fita */
...
export type NewHairImplanterProps = {
  durationSeconds: number;
  video: string;
};

export const NewHairImplanter: React.FC<NewHairImplanterProps> = ({ video }) => {
