...
const PECA = {
  ...
  video: "newhair/preparo_h264.mp4",
  ...
  /* MEDIDO. true = fita CLARA: aqui a faixa da legenda vai de 70 a 184 de brilho
     (pico na bandeja branca de grafts, 6.4s a 8.7s). Com o veu padrao o dourado
     some ali, entao o scrim vai mais pesado e o texto ganha contorno. */
  fitaClara: true,
...
const TITULO = {
  linhas: [
    "MÉDICO, SUA EQUIPE PREPARA",
    "A CIRURGIA OU COMEÇA A SE",
    "ORGANIZAR COM O PACIENTE",
    "JÁ NA SALA?",
  ],
  ...
  seguraAte: 2.6, // corte medido aos 2.65s: a fita vira pro preto sozinha
  saiEm: 2.9, // o titulo sai EM CIMA da virada — tela limpa de graca
};
...
const CUES: Cue[] = [
  {
    ...
    lines: [{ text: "MESA.", size: 46, gold: true }],
  },
  {
    start: 4.75,
    end: 6.0,
    lines: [{ text: "MATERIAIS.", size: 46, gold: true }],
  },
  {
    start: 6.45,
    end: 7.6,
    lines: [{ text: "FUNÇÕES.", size: 46, gold: true }],
  },
  {
    start: 7.75,
    end: 9.3,
  ...
  },
  {
    ...
    lines: [
      { text: "Na New Hair, a cirurgia começa", size: 28 },
      { text: "ANTES DO PRIMEIRO ENXERTO.", size: 38, gold: true },
    ],
  },
  {
    start: 13.1,
    ...
    lines: [
      { text: "Porque quando o paciente entra,", size: 28 },
      { text: "O BÁSICO JÁ PRECISA ESTAR PRONTO.", size: 34, gold: true },
    ],
  },
];
...
export type NewHairPreparoProps = {
  durationSeconds: number;
  video: string;
};

export const NewHairPreparo: React.FC<NewHairPreparoProps> = ({ video }) => {
