...
const PECA = {
  ...
  video: "newhair/passofrente_h264.mp4",
...
const TITULO = {
  ...
  seguraAte: 4.5, // corte aos 4.75s
  saiEm: 4.75, // saída sobre o corte
};
...
const CUES: Cue[] = [
  ...
  },
  {
    ...
    lines: [
      ...
      { text: "deixar o próximo passo preparado.", size: 26, gold: true },
    ],
  },
];
...
export type NewHairPassoFrenteProps = {
  durationSeconds: number;
  video: string;
};

export const NewHairPassoFrente: React.FC<NewHairPassoFrenteProps> = ({ video }) => {
