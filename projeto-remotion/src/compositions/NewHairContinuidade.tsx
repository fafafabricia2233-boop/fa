...
const PECA = {
  ...
  video: "newhair/continuidade_h264.mp4",
...
const TITULO = {
  ...
  seguraAte: 4.5, // sem cortes cedo neste video, titulo de 5 linhas — segura mais
  saiEm: 4.8,
};
...
const CUES: Cue[] = [
  {
    ...
    lines: [{ text: "Toda vez você precisa EXPLICAR DE NOVO.", size: 36, gold: true }],
  },
  {
    start: 7.0,
    end: 7.8,
    lines: [{ text: "PREFERÊNCIAS.", size: 46, gold: true }],
  },
  {
    start: 8.0,
    end: 8.8,
  ...
  },
  {
    ...
    lines: [{ text: "Forma de TRABALHAR.", size: 42, gold: true }],
  },
  {
    start: 10.0,
    end: 12.2,
    lines: [
      { text: "Na New Hair, a proposta é", size: 32 },
      { text: "construir CONTINUIDADE.", size: 40, gold: true },
    ],
  },
  {
    start: 12.4,
    ...
    lines: [
      { text: "Porque parceria de verdade melhora", size: 30 },
      { text: "quando a equipe CONHECE VOCÊ.", size: 36, gold: true },
    ],
  },
];
...
export type NewHairContinuidadeProps = {
  durationSeconds: number;
  video: string;
};

export const NewHairContinuidade: React.FC<NewHairContinuidadeProps> = ({ video }) => {
