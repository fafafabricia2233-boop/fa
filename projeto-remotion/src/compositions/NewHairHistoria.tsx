...
const PECA = {
  ...
  video: "newhair/historia_h264.mp4",
...
const TITULO = {
  ...
  seguraAte: 7.0, // cortes aos 7.55s
  saiEm: 7.3, // saída antes dos cortes
};
...
const CUES: Cue[] = [
  {
    ...
    lines: [
      { text: "Antes da marcação,", size: 34 },
      { text: "EXPECTATIVAS. INSEGURANÇAS", size: 46, gold: true },
    ],
  },
  {
    start: 9.2,
    ...
    lines: [
      { text: "E um motivo que trouxe", size: 34 },
      { text: "AQUELE PACIENTE ATÉ ALI", size: 46, gold: true },
    ],
  },
  {
    start: 10.5,
    ...
    lines: [
      { text: "Nossa equipe também", size: 34 },
      { text: "PRECISA SABER ACOLHER ISSO", size: 46, gold: true },
    ],
  },
];
...
export type NewHairHistoriaProps = {
  durationSeconds: number;
  video: string;
};

export const NewHairHistoria: React.FC<NewHairHistoriaProps> = ({ video }) => {
