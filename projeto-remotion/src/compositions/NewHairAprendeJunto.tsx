...
const PECA = {
  /* Fita montada do take cru IMG_9788.MOV. O take tem QUATRO tentativas do
     gancho (a 1a, 2a e 3a morrem no meio: "...mas os..."). Ficou so a 4a, que
     e a unica inteira. Tambem saiu o "isso" solto no fim de "centro cirurgico". */
  video: "newhair/aprendejunto_h264.mp4",
  ...
  geometria: {
    ...
    // fita comeca em y=525px (menor valor de todos os frames — ela mexe
    // a cabeca enquanto fala). O bloco de titulo tem 333px (5 linhas,
    // mais o fio e o "Leia a legenda"). 525 - 45 de folga - 333 = 147.
...
const TITULO = {
  /* gancho longo: 5 linhas em vez de 4. O teto de 2s da datilografia nao muda —
     e o mesmo calculo, so repartido em mais linha.
     A quebra foi conferida em still: a ultima linha sai em 44px e NAO quebra
     sozinha (span de largura fixa), entao ela tem que caber nos 780px uteis
     (1080 menos os 150 de padding de cada lado). "CHEGA E AFASTA TODO MUNDO?"
     vazava; "E AFASTA TODO MUNDO?" cabe. */
  linhas: [
    "DOUTOR, VOCÊ QUER QUE SEUS",
    "PROFISSIONAIS APRENDAM E",
    "ACOMPANHEM A ROTINA, MAS A",
    "EQUIPE CONTRATADA CHEGA",
    "E AFASTA TODO MUNDO?",
  ],
...
const CUES: Cue[] = [
  ...
  },
  {
    ...
    lines: [
      ...
      { text: "CENTRO CIRÚRGICO.", size: 34, gold: true },
    ],
  },
  {
    start: 18.80,
...
export type NewHairAprendeJuntoProps = {
  durationSeconds: number;
  video: string;
};

export const NewHairAprendeJunto: React.FC<NewHairAprendeJuntoProps> = ({ video }) => {
