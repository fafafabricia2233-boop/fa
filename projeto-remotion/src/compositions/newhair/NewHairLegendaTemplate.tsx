/* =============================================================================
   ...
   Padrao da frente, edicao 24/08/2026. Motor: Remotion.

   COMO USAR (o Claude faz isso, nao a mao):
   1. Copie este arquivo em src/compositions/newhair/ com o nome da peca.
      Ex.: NewHairGelox.tsx
   ...
   4. Registre no Root.tsx com o snippet que esta no arquivo de padrao (PADRAO_LEGENDA_REEL.md).
...
const PECA = {
  ...
  video: "newhair/NOME_DA_FITA_h264.mp4",

  /* MEDIDO com scripts/medir-fita.py, nunca herdado da peca anterior.
...
export type NewHairLegendaProps = {
  durationSeconds: number;
  video: string;
};

export const NewHairLegenda: React.FC<NewHairLegendaProps> = ({ video }) => {
