...
const PECA = {
  ...
  video: "newhair/ensinardependencia_h264.mp4",
...
const TITULO = {
  ...
  seguraAte: 2.1, // corte aos 2.30s
  saiEm: 2.3, // saída sobre o corte
};
...
const CUES: Cue[] = [
  {
    ...
    lines: [{ text: "Quando ninguém pode OBSERVAR.", size: 40, gold: true }],
  },
  {
    start: 4.5,
    end: 6.3,
    lines: [{ text: "Ninguém pode APRENDER.", size: 42, gold: true }],
  },
  {
    start: 6.5,
    end: 8.3,
    lines: [{ text: "Ninguém pode PARTICIPAR.", size: 42, gold: true }],
  },
  {
    start: 8.5,
    end: 10.5,
    lines: [{ text: "Isso deixa de ser SUPORTE e vira DEPENDÊNCIA.", size: 34, gold: true }],
  },
  {
    start: 10.7,
    end: 13.0,
    lines: [
      { text: "Na New Hair, CONHECIMENTO não é usado", size: 32, gold: true },
      { text: "para prender a clínica.", size: 30 },
    ],
  },
  {
    start: 13.2,
    end: 15.0,
    lines: [{ text: "A gente INTEGRA, ORIENTA E SOMA.", size: 40, gold: true }],
  },
];
...
export type NewHairEnsinarDependenciaProps = {
  durationSeconds: number;
  video: string;
};

export const NewHairEnsinarDependencia: React.FC<NewHairEnsinarDependenciaProps> = ({ video }) => {
