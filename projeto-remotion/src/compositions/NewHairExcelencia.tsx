...
const PECA = {
  ...
  video: "newhair/excelencia_h264.mp4",
...
const TITULO = {
  ...
  seguraAte: 6.0, // cortes aos 6.35s
  saiEm: 6.3, // saída antes dos cortes
};
...
const CUES: Cue[] = [
  {
    ...
    lines: [
      { text: "Começa quando o paciente entra.", size: 34 },
      { text: "NA RECEPÇÃO. NA CONVERSA", size: 46, gold: true },
    ],
  },
  {
    start: 8.2,
    end: 9.5,
    lines: [{ text: "NA SEGURANÇA TRANSMITIDA", size: 46, gold: true }],
  },
  {
    start: 9.5,
    end: 13.5,
    lines: [
      { text: "Antes da técnica,", size: 34 },
      { text: "JÁ EXISTE EXPERIÊNCIA", size: 46, gold: true },
    ],
  },
];
...
export type NewHairExcelenciaProps = {
  durationSeconds: number;
  video: string;
};

export const NewHairExcelencia: React.FC<NewHairExcelenciaProps> = ({ video }) => {
