...
const PECA = {
  ...
  video: "newhair/foliaculo_h264.mp4",
...
const TITULO = {
  ...
  seguraAte: 1.8, // corte aos 2.0s
  saiEm: 2.0, // saída sobre o corte
};
...
const CUES: Cue[] = [
  {
    ...
    lines: [{ text: "Depois que ele sai DAS SUAS MÃOS", size: 46, gold: true }],
  },
  {
    start: 6.0,
    end: 7.8,
    lines: [
      { text: "Será SEPARADO,", size: 46, gold: true },
      { text: "contado e manipulado", size: 34 },
    ],
  },
  {
    start: 8.0,
  ...
  },
  {
    ...
    lines: [
      { text: "Para PRESERVAR o enxerto", size: 46, gold: true },
      { text: "até a implantação", size: 34 },
    ],
  },
];
...
export type NewHairFoliculoProps = {
  durationSeconds: number;
  video: string;
};

export const NewHairFoliculo: React.FC<NewHairFoliculoProps> = ({ video }) => {
