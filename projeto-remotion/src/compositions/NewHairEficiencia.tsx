...
const PECA = {
  ...
  video: "newhair/eficiencia_h264.mp4",
  ...
  /* MEDIDO. true = fita CLARA: a faixa da legenda vai de 90 a 168 de brilho, e o
     quadro tem estouros de luz (238 aos 5.35s). Com o veu padrao o dourado some,
     entao o scrim vai mais pesado e o texto ganha contorno. */
  fitaClara: true,
...
const TITULO = {
  linhas: [
    "MÉDICO, SUA EQUIPE SABE",
    "EM QUE MOMENTO DA CIRURGIA",
    "ELA PRECISA SER MAIS RÁPIDA",
    "E EM QUAL PRECISA SER",
    "MAIS CUIDADOSA?",
  ],
  ...
  seguraAte: 2.6, // corte medido aos 2.85s (o seguinte so aos 5.05s, longe demais)
  saiEm: 2.85, // o titulo sai EM CIMA da virada — tela limpa de graca
};
...
const CUES: Cue[] = [
  {
    ...
    lines: [{ text: "Nem toda etapa pede O MESMO RITMO.", size: 36, gold: true }],
  },
  {
    start: 6.2,
    end: 10.4,
    lines: [
      { text: "Na New Hair, a equipe entende que", size: 28 },
      { text: "EFICIÊNCIA NÃO É FAZER TUDO RÁPIDO.", size: 34, gold: true },
    ],
  },
  {
    start: 10.8,
    ...
    lines: [
      { text: "É SABER ONDE GANHAR TEMPO", size: 38, gold: true },
      { text: "sem perder qualidade.", size: 28 },
    ],
  },
];
...
export type NewHairEficienciaProps = {
  durationSeconds: number;
  video: string;
};

export const NewHairEficiencia: React.FC<NewHairEficienciaProps> = ({ video }) => {
