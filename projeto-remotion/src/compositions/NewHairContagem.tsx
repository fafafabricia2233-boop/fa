...
const PECA = {
  ...
  video: "newhair/contagem_h264.mp4",
...
const TITULO = {
  ...
  seguraAte: 3.0, // texto denso, fita curta (11.53s), corte aos 3.25s — segura menos
  saiEm: 3.25,
};
...
const CUES: Cue[] = [
  {
    ...
    lines: [{ text: "Unidade folicular não é FIO.", size: 38, gold: true }],
  },
  {
    start: 5.0,
    end: 6.8,
    lines: [
      { text: "E uma contagem mal feita pode", size: 28 },
      { text: "BAGUNÇAR TODA A LEITURA da cirurgia.", size: 32, gold: true },
    ],
  },
  {
    start: 7.0,
    ...
    lines: [
      { text: "Na New Hair, CONTAGEM é processo,", size: 32, gold: true },
      { text: "CONFERÊNCIA e responsabilidade.", size: 30, gold: true },
    ],
  },
  {
    start: 9.5,
    ...
    lines: [
      { text: "Você precisa de NÚMEROS", size: 34, gold: true },
      { text: "em que possa confiar.", size: 28 },
    ],
  },
];
...
export type NewHairContagemProps = {
  durationSeconds: number;
  video: string;
};

export const NewHairContagem: React.FC<NewHairContagemProps> = ({ video }) => {
