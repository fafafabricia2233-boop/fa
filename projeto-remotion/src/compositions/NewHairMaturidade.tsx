...
const PECA = {
  ...
  video: "newhair/maturidade_h264.mp4",
...
const CUES: Cue[] = [
  {
    ...
    lines: [
      { text: "Quando algo sai", size: 34 },
      { text: "DIFERENTE DO PLANEJADO", size: 46, gold: true },
    ],
  },
  {
    start: 9.3,
    ...
    lines: [
      { text: "Sem pânico.", size: 38 },
      { text: "Sem barulho.", size: 38 },
    ],
  },
  {
    start: 11.3,
    ...
    lines: [
      { text: "Sem transformar", size: 34 },
      { text: "o problema em problema", size: 34 },
      { text: "PARA O MÉDICO", size: 46, gold: true },
    ],
  },
];
...
export type NewHairMaturidadeProps = {
  durationSeconds: number;
  video: string;
};

export const NewHairMaturidade: React.FC<NewHairMaturidadeProps> = ({ video }) => {
