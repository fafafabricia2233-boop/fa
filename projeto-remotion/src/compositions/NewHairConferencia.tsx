...
const PECA = {
  ...
  video: "newhair/conferencia_h264.mp4",
  ...
  /* MEDIDO. true = fita CLARA: a faixa da legenda fica entre 84 e 151 de brilho a
     fita inteira. Com o veu padrao o dourado some ali, entao o scrim vai mais
     pesado e o texto ganha contorno. */
  fitaClara: true,
...
const TITULO = {
  linhas: [
    "MÉDICO, QUANTOS ERROS",
    "SÓ APARECEM QUANDO",
    "JÁ CHEGARAM ATÉ VOCÊ?",
  ],
  ...
  seguraAte: 3.5, // a fita passa pelo preto entre 3.65s e 3.75s (medido)
  saiEm: 3.75, // o titulo morre DENTRO do preto — virada de graca
};
...
const CUES: Cue[] = [
  {
    ...
    lines: [
      { text: "Na New Hair, a equipe", size: 28 },
      { text: "NÃO TRABALHA SEM CONFERÊNCIA.", size: 38, gold: true },
    ],
  },
  {
    start: 6.2,
    end: 7.6,
    lines: [{ text: "Existe SUPERVISÃO DA MESA.", size: 38, gold: true }],
  },
  {
    start: 7.75,
    end: 9.15,
    lines: [{ text: "ACOMPANHAMENTO DO FLUXO.", size: 40, gold: true }],
  },
  {
    start: 9.9,
    end: 11.3,
    lines: [{ text: "REVISÃO DURANTE O PROCESSO.", size: 38, gold: true }],
  },
  {
    start: 11.6,
    end: 14.5,
    lines: [
      { text: "Porque o médico não deveria ser", size: 28 },
      { text: "A ÚLTIMA BARREIRA PARA PERCEBER O BÁSICO.", size: 28, gold: true },
    ],
  },
];
...
export type NewHairConferenciaProps = {
  durationSeconds: number;
  video: string;
};

export const NewHairConferencia: React.FC<NewHairConferenciaProps> = ({ video }) => {
