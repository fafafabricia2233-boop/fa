...
const PECA = {
  ...
  video: "newhair/confiaenxerto_h264.mp4",
...
const TITULO = {
  ...
  seguraAte: 3.1, // texto MUITO denso, fita muito curta (11.07s), corte aos 3.35s
  saiEm: 3.35, // saída sobre o corte
};
...
const CUES: Cue[] = [
  {
    ...
    lines: [
      { text: "Porque você não consegue acompanhar", size: 24 },
      { text: "cada mão durante toda a cirurgia.", size: 26, gold: true },
    ],
  },
  {
    start: 5.2,
    ...
    lines: [
      { text: "Na New Hair, cuidado com o folículo", size: 24 },
      { text: "não depende de SUPERVISÃO CONSTANTE.", size: 26, gold: true },
    ],
  },
  {
    start: 6.8,
    end: 7.4,
    lines: [{ text: "É TREINAMENTO.", size: 40, gold: true }],
  },
  {
    start: 7.4,
    end: 8.0,
    lines: [{ text: "É PADRÃO.", size: 42, gold: true }],
  },
  {
    start: 8.0,
    end: 8.6,
    lines: [{ text: "É RESPONSABILIDADE.", size: 36, gold: true }],
  },
  {
    start: 8.8,
    end: 9.4,
    lines: [{ text: "Você cuida da SUA TÉCNICA.", size: 32, gold: true }],
  },
  {
    start: 9.4,
    end: 10.3,
    lines: [
      { text: "A equipe precisa saber cuidar", size: 24 },
      { text: "do que você entregou a ela.", size: 24 },
    ],
  },
];
...
export type NewHairConfiaEnxertoProps = {
  durationSeconds: number;
  video: string;
};

export const NewHairConfiaEnxerto: React.FC<NewHairConfiaEnxertoProps> = ({ video }) => {
