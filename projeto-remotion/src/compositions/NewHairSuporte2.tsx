...
const PECA = {
  ...
  video: "newhair/suporte2_h264.mp4",
  ...
  /* MEDIDO com medir-fita.py, nunca herdado da peca anterior.
     ...
     ATENCAO: mesmo arquivo-fonte da NewHairAnsioso (md5 identico), texto/legenda
     totalmente diferentes — reels distintos reusando o mesmo B-roll. */
  endCard: 11.50,
...
const TITULO = {
  ...
  seguraAte: 3.0, // texto denso, fita curta (11.5s) — segura menos
  saiEm: 3.2,
};
...
const CUES: Cue[] = [
  ...
  },
  {
    ...
    lines: [{ text: "FLUXO.", size: 46, gold: true }],
  },
  {
    start: 4.5,
    end: 5.3,
  ...
  },
  {
    ...
    lines: [{ text: "PRÓXIMA ETAPA.", size: 42, gold: true }],
  },
  {
    start: 6.5,
    end: 8.3,
    lines: [{ text: "Na New Hair, o OBJETIVO é simples:", size: 36, gold: true }],
  },
  {
    start: 8.3,
    end: 9.8,
    lines: [{ text: "você cuida DA CIRURGIA.", size: 40, gold: true }],
  },
  {
    start: 9.8,
    end: 11.4,
    lines: [{ text: "A gente cuida para o processo ACOMPANHAR VOCÊ.", size: 34, gold: true }],
  },
];
...
export type NewHairSuporte2Props = {
  durationSeconds: number;
  video: string;
};

export const NewHairSuporte2: React.FC<NewHairSuporte2Props> = ({ video }) => {
