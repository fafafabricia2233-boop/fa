...
const PECA = {
  ...
  video: "newhair/basicopadrao_h264.mp4",
...
const TITULO = {
  ...
  seguraAte: 3.6, // corte aos 3.80s
  saiEm: 3.8, // saída sobre o corte
};
...
const CUES: Cue[] = [
  {
    ...
    lines: [{ text: "MESA ORGANIZADA.", size: 42, gold: true }],
  },
  {
    start: 5.3,
    end: 6.3,
    lines: [{ text: "Enxerto bem MANIPULADO.", size: 40, gold: true }],
  },
  {
    start: 6.9,
    end: 8.4,
    lines: [{ text: "Paciente bem TRATADO.", size: 42, gold: true }],
  },
  {
    start: 8.8,
    end: 10.6,
    lines: [{ text: "PRÓXIMA ETAPA preparada.", size: 40, gold: true }],
  },
  {
    start: 10.8,
    end: 13.2,
    lines: [
      { text: "Na New Hair, o BÁSICO", size: 40, gold: true },
      { text: "não é detalhe.", size: 34 },
    ],
  },
  {
    start: 13.7,
    end: 16.3,
    lines: [{ text: "É PADRÃO.", size: 48, gold: true }],
  },
];
...
export type NewHairBasicoPadraoProps = {
  durationSeconds: number;
  video: string;
};

export const NewHairBasicoPadrao: React.FC<NewHairBasicoPadraoProps> = ({ video }) => {
