...
const PECA = {
  ...
  video: "newhair/registro_h264.mp4",
...
const TITULO = {
  ...
  seguraAte: 3.7, // corte/flash aos 3.90-3.95s
  saiEm: 3.95, // saída sobre o flash
};
...
const CUES: Cue[] = [
  ...
  },
  {
    ...
    lines: [{ text: "INCISÕES.", size: 46, gold: true }],
  },
  {
    start: 6.2,
    end: 7.2,
  ...
  },
  {
    ...
    lines: [{ text: "Detalhes IMPORTANTES da cirurgia.", size: 42, gold: true }],
  },
  {
    start: 9.8,
    end: 13.6,
    lines: [
      { text: "Na New Hair, REGISTRO também", size: 34 },
      { text: "faz parte do nosso PROTOCOLO.", size: 44, gold: true },
    ],
  },
];
...
export type NewHairRegistroProps = {
  durationSeconds: number;
  video: string;
};

export const NewHairRegistro: React.FC<NewHairRegistroProps> = ({ video }) => {
