...
const PECA = {
  ...
  video: "newhair/funcoes_h264.mp4",
  ...
  /* MEDIDO. true = fita CLARA: a faixa da legenda vai de 60 a 155 de brilho, com
     o trecho claro entre 6.0s e 8.4s. Com o veu padrao o dourado some ali, entao
     o scrim vai mais pesado e o texto ganha contorno. */
  fitaClara: true,
...
const TITULO = {
  linhas: [
    "MÉDICO, QUANTAS VEZES VOCÊ",
    "PRECISA PARAR A CIRURGIA",
    "PORQUE A PRÓPRIA EQUIPE",
    "NÃO SE ENTENDE?",
  ],
  ...
  seguraAte: 2.9, // a fita passa pelo preto entre 3.05s e 3.15s (medido)
  saiEm: 3.15, // o titulo morre DENTRO do preto — virada de graca
};
...
const CUES: Cue[] = [
  {
    ...
    lines: [{ text: "QUEM CONTA.", size: 46, gold: true }],
  },
  {
    start: 4.45,
    end: 5.45,
    lines: [{ text: "QUEM ORGANIZA.", size: 46, gold: true }],
  },
  {
    start: 5.55,
    end: 6.55,
    lines: [{ text: "QUEM CARREGA.", size: 46, gold: true }],
  },
  {
    start: 6.65,
    end: 8.5,
    lines: [{ text: "QUEM ACOMPANHA A PRÓXIMA ETAPA.", size: 34, gold: true }],
  },
  {
    start: 8.9,
    end: 11.35,
    lines: [
      { text: "Na New Hair, cada função é definida", size: 28 },
      { text: "ANTES DA CIRURGIA COMEÇAR.", size: 38, gold: true },
    ],
  },
];
...
export type NewHairFuncoesProps = {
  durationSeconds: number;
  video: string;
};

export const NewHairFuncoes: React.FC<NewHairFuncoesProps> = ({ video }) => {
