...
const PECA = {
  ...
  video: "newhair/saidasala_h264.mp4",
...
const CUES: Cue[] = [
  {
    ...
    lines: [
      { text: "É nesse momento que você descobre", size: 30 },
      { text: "o PADRÃO REAL de uma equipe.", size: 38, gold: true },
    ],
  },
  {
    start: 7.5,
    end: 10.0,
    lines: [{ text: "Na New Hair, RESPEITO, ACOLHIMENTO e POSTURA", size: 30, gold: true }],
  },
  {
    start: 10.2,
    end: 12.5,
    lines: [{ text: "não dependem da presença do médico.", size: 32 }],
  },
  {
    start: 12.8,
    end: 15.7,
    lines: [
      { text: "O paciente é BEM TRATADO", size: 38, gold: true },
      { text: "do início ao fim.", size: 32 },
    ],
  },
];
...
export type NewHairSaidaSalaProps = {
  durationSeconds: number;
  video: string;
};

export const NewHairSaidaSala: React.FC<NewHairSaidaSalaProps> = ({ video }) => {
