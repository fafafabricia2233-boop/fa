...
const TITULO = {
  linhas: [
    "MÉDICO, PARA VOCÊ",
    "PODE SER MAIS UMA CIRURGIA.",
    "PARA ELE, PODE SER UM DIA",
    "ESPERADO HÁ ANOS.",
  ],
  ...
  seguraAte: 3.4, // flash aos 3.65s
  saiEm: 3.65, // saída sobre o flash
};
...
const CUES: Cue[] = [
  {
    ...
    lines: [
      { text: "Na New Hair, o paciente", size: 32 },
      { text: "NÃO É TRATADO como mais um da agenda.", size: 40, gold: true },
    ],
  },
  {
    start: 9.0,
    end: 10.0,
    lines: [{ text: "A gente RECEBE.", size: 46, gold: true }],
  },
  {
    start: 10.0,
    end: 11.0,
    lines: [{ text: "ESCUTA.", size: 48, gold: true }],
  },
  {
    start: 11.0,
    end: 12.0,
    lines: [{ text: "EXPLICA.", size: 48, gold: true }],
  },
  {
    start: 12.2,
    end: 19.4,
    lines: [{ text: "E ACOLHE desde o primeiro contato.", size: 42, gold: true }],
  },
];
...
export type NewHairMaisUmProps = {
  durationSeconds: number;
  video: string;
};

export const NewHairMaisUm: React.FC<NewHairMaisUmProps> = ({ video }) => {
