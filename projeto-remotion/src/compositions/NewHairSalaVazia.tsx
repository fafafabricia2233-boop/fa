/* =============================================================================
   ...
   1. Copie este arquivo em src/compositions/ com o nome da peca.
      Ex.: NewHairGelox.tsx
   2. Troque NewHairSalaVazia por NewHairGelox nas 3 ocorrencias do fim do arquivo
...
const PECA = {
  ...
  video: "newhair/salavazia_h264.mp4",
  ...
  endCard: null as number | null,   /* MEDIDO: nao tem end card */
...
const TITULO = {
  ...
  /* PERMANENTE por ordem da dona: "manter durante todo video". */
...
const CUES: Cue[] = [
  /* UMA cue so, por ordem da dona: "aparecer segundos depois do titulo e ficar
     ate o final". Entra em 2.50s — 1.3s depois do titulo terminar de ser
     escrito — e vai ate o fim da fita.

     TRES LINHAS, acima das duas que o padrao recomenda por cue. A regra das
     duas linhas existe pra cue que troca em sequencia nao virar parede; aqui e
     um bloco unico que fica parado, e a quebra em tres e da propria dona.

     SERIF (Cormorant): ela mandou o texto em italico matematico unicode
     (𝐷𝑒 𝑢𝑚𝑎 𝑠𝑎𝑙𝑎...). Montserrat e Cormorant nao tem esses glifos e sairiam
     como quadrados na tela, entao converti pra texto normal e usei a fonte
     serifada do padrao, que e a opcao elegante da casa.

     SEM DOURADO de proposito: o titulo e permanente e ja carrega o remate
     dourado "EXATAMENTE AQUI" na tela o video inteiro. Um segundo dourado
     parado embaixo por 4s brigaria com ele. O off-white serifado deixa o
     dourado do titulo ser o unico acento. */
  {
    start: 2.5,
    end: 6.8,
    lines: [
      { text: "De uma sala vazia", size: 36, font: "serif" },
      { text: "para um ambiente preparado", size: 36, font: "serif" },
      { text: "para cada etapa.", size: 36, font: "serif" },
    ],
  },
];
...
export type NewHairSalaVaziaProps = {
  durationSeconds: number;
  video: string;
};

export const NewHairSalaVazia: React.FC<NewHairSalaVaziaProps> = ({ video }) => {
