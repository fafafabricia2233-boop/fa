/* =============================================================================
   ...
   1. Copie este arquivo em src/compositions/ com o nome da peca.
      Ex.: NewHairGelox.tsx
   2. Troque NewHairEquipe por NewHairGelox nas 3 ocorrencias do fim do arquivo
...
const PECA = {
  ...
  endCard: 7.45 as number | null,   /* MEDIDO nesta fita */
...
const TITULO = {
  /* Texto dado pela dona, palavra por palavra. O vocativo "MÉDICO," e dela:
     o padrao so proibe INVENTAR vocativo que ninguem disse. */
  linhas: [
    "MÉDICO, SUA EQUIPE",
    "RESOLVE PROBLEMAS OU LEVA",
    "MAIS PROBLEMAS ATÉ VOCÊ?",
  ],
  ...
  /* TEMPORARIO: o topo do quadro e B-roll da equipe operando, que E a prova.
     A regra 6 manda o titulo sair e levar o veu de cima junto, deixando a
     prova limpa. Sai no corte medido em 6.05s, que e a virada para o plano
     final do campo — o titulo pergunta, e a imagem responde sem texto por cima. */
  modo: "temporario" as "temporario" | "permanente",

  inicio: 0.15, // quando a primeira letra aparece
  seguraAte: 5.85, // segura ate aqui
  saiEm: 6.05, // some EM CIMA do corte medido em 6.05s
};
...
const CUES: Cue[] = [
  /* VAZIO: a dona mandou so o titulo. Fita sem fala, entao nao ha frase para
     colar no rodape — e escrever qualquer coisa aqui seria inventar. */
];
...
export type NewHairEquipeProps = {
  durationSeconds: number;
  video: string;
};

export const NewHairEquipe: React.FC<NewHairEquipeProps> = ({ video }) => {
