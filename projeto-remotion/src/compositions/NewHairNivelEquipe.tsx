...
const PECA = {
  ...
  video: "newhair/nivelequipe_h264.mp4",
...
const TITULO = {
  ...
  seguraAte: 2.9, // texto denso, fita curta (12.3s), corte aos 3.15s — segura menos
  saiEm: 3.15,
};
...
const CUES: Cue[] = [
  {
    ...
    lines: [
      { text: "Porque operar em ALTO NÍVEL exige mais", size: 30, gold: true },
      { text: "do que uma boa execução.", size: 26 },
    ],
  },
  {
    start: 5.7,
    end: 6.5,
    lines: [{ text: "Exige ORGANIZAÇÃO.", size: 40, gold: true }],
  },
  {
    start: 6.5,
    end: 7.3,
    lines: [{ text: "LEITURA de cirurgia.", size: 40, gold: true }],
  },
  {
    start: 7.3,
    end: 8.1,
    lines: [{ text: "Cuidado com o ENXERTO.", size: 38, gold: true }],
  },
  {
    start: 8.1,
    end: 8.9,
    lines: [{ text: "POSTURA.", size: 44, gold: true }],
  },
  {
    start: 9.1,
    end: 12.2,
    lines: [
      { text: "Na New Hair, a equipe precisa", size: 30 },
      { text: "acompanhar o NÍVEL do cirurgião.", size: 36, gold: true },
    ],
  },
];
...
export type NewHairNivelEquipeProps = {
  durationSeconds: number;
  video: string;
};

export const NewHairNivelEquipe: React.FC<NewHairNivelEquipeProps> = ({ video }) => {
