...
const PECA = {
  ...
  video: "newhair/aprendecomvoce_h264.mp4",
...
const TITULO = {
  ...
  seguraAte: 3.0, // fita curta (11.13s) com muito texto — segura o suficiente pra ler o titulo
  saiEm: 3.2,
};
...
const CUES: Cue[] = [
  {
    ...
    lines: [
      { text: "SUA PREFERÊNCIA.", size: 30, gold: true },
      { text: "SEU RITMO.", size: 30, gold: true },
      { text: "SUA SEQUÊNCIA.", size: 30, gold: true },
      { text: "Seu jeito de CONDUZIR.", size: 30, gold: true },
    ],
  },
  {
    start: 5.7,
    ...
    lines: [
      { text: "Na New Hair, uma cirurgia precisa", size: 26 },
      { text: "deixar a próxima ainda mais ALINHADA.", size: 30, gold: true },
    ],
  },
  {
    start: 8.5,
    ...
    lines: [
      { text: "Porque parceria de alto nível também é", size: 24 },
      { text: "construir PADRÃO junto com o médico.", size: 28, gold: true },
    ],
  },
];
...
export type NewHairAprendeComVoceProps = {
  durationSeconds: number;
  video: string;
};

export const NewHairAprendeComVoce: React.FC<NewHairAprendeComVoceProps> = ({ video }) => {
