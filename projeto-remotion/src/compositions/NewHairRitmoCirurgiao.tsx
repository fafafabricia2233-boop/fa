...
const PECA = {
  ...
  video: "newhair/ritmocirurgiao_h264.mp4",
...
const TITULO = {
  ...
  seguraAte: 2.2, // texto MUITO denso, fita muito curta (10.1s) — segura o mínimo
  saiEm: 2.4,
};
...
const CUES: Cue[] = [
  {
    ...
    lines: [{ text: "MATERIAL que atrasa.", size: 40, gold: true }],
  },
  {
    start: 3.7,
    end: 4.4,
    lines: [{ text: "ETAPA que não está pronta.", size: 34, gold: true }],
  },
  {
    start: 4.4,
    end: 5.1,
    lines: [{ text: "Equipe esperando ORDEM.", size: 36, gold: true }],
  },
  {
    start: 5.3,
    end: 7.0,
    lines: [
      { text: "Na New Hair, o fluxo é pensado", size: 26 },
      { text: "para acompanhar o RITMO do cirurgião.", size: 30, gold: true },
    ],
  },
  {
    start: 7.2,
    end: 7.8,
    lines: [{ text: "SEM PRESSA.", size: 42, gold: true }],
  },
  {
    start: 8.1,
    end: 8.7,
    lines: [{ text: "SEM CORRERIA.", size: 40, gold: true }],
  },
  {
    start: 8.7,
    end: 9.6,
    lines: [{ text: "Sem tempo perdido com o BÁSICO.", size: 30, gold: true }],
  },
];
...
export type NewHairRitmoCirurgiaoProps = {
  durationSeconds: number;
  video: string;
};

export const NewHairRitmoCirurgiao: React.FC<NewHairRitmoCirurgiaoProps> = ({ video }) => {
