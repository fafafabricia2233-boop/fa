...
const PECA = {
  ...
  video: "newhair/pressao_h264.mp4",
...
const CUES: Cue[] = [
  {
    ...
    lines: [{ text: "Ela aparece NO IMPREVISTO.", size: 44, gold: true }],
  },
  {
    start: 6.2,
    end: 7.7,
    lines: [{ text: "Quando é preciso PENSAR RÁPIDO.", size: 42, gold: true }],
  },
  {
    start: 7.7,
    end: 8.9,
    lines: [{ text: "MANTER A CALMA.", size: 46, gold: true }],
  },
  {
    start: 9.1,
    end: 11.3,
    lines: [
      { text: "E continuar o fluxo sem jogar", size: 32 },
      { text: "O PROBLEMA PARA VOCÊ.", size: 42, gold: true },
    ],
  },
  {
    start: 11.5,
    ...
    lines: [
      { text: "Na New Hair, PREPARO também é", size: 34 },
      { text: "saber agir SOB PRESSÃO.", size: 44, gold: true },
    ],
  },
];
...
export type NewHairPressaoProps = {
  durationSeconds: number;
  video: string;
};

export const NewHairPressao: React.FC<NewHairPressaoProps> = ({ video }) => {
