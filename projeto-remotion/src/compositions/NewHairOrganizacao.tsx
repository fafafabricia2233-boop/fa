...
const PECA = {
  ...
  video: "newhair/organizacao_h264.mp4",
...
const TITULO = {
  ...
  saiEm: 3.0, // saída antes do corte
};
...
const CUES: Cue[] = [
  {
    ...
    lines: [{ text: "Instrumental FORA DO LUGAR.", size: 44, gold: true }],
  },
  {
    start: 4.9,
    end: 6.6,
    lines: [{ text: "Material que NÃO FOI PREPARADO.", size: 42, gold: true }],
  },
  {
    start: 6.8,
    end: 8.6,
    lines: [{ text: "Equipe perguntando O QUE FAZER.", size: 42, gold: true }],
  },
  {
    start: 8.8,
    end: 11.0,
    lines: [
      { text: "Na New Hair,", size: 34 },
      { text: "ORGANIZAÇÃO faz parte do PROTOCOLO.", size: 40, gold: true },
    ],
  },
  {
    start: 11.2,
    end: 13.3,
    lines: [{ text: "Porque cirurgia organizada FLUI MELHOR.", size: 42, gold: true }],
  },
];
...
export type NewHairOrganizacaoProps = {
  durationSeconds: number;
  video: string;
};

export const NewHairOrganizacao: React.FC<NewHairOrganizacaoProps> = ({ video }) => {
