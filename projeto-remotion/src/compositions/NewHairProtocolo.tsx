...
const PECA = {
  ...
  video: "newhair/protocolo_h264.mp4",
...
const TITULO = {
  ...
  seguraAte: 6.3, // corte aos 6.95s
  saiEm: 6.8, // saída antes do corte
};
...
const CUES: Cue[] = [
  {
    ...
    lines: [
      { text: "Por isso, a New Hair tem", size: 34 },
      { text: "PROTOCOLO DE RECEPÇÃO", size: 46, gold: true },
    ],
  },
  {
    start: 8.5,
    ...
    lines: [
      { text: "Acolher. Ouvir.", size: 38 },
      { text: "Explicar. TRANSMITIR SEGURANÇA", size: 38, gold: false },
    ],
  },
  {
    start: 10.8,
    ...
    lines: [
      { text: "Porque nenhum paciente", size: 34 },
      { text: "deve se sentir SÓ UM", size: 46, gold: true },
    ],
  },
];
...
export type NewHairProtocoloProps = {
  durationSeconds: number;
  video: string;
};

export const NewHairProtocolo: React.FC<NewHairProtocoloProps> = ({ video }) => {
