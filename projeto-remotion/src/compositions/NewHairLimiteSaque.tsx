...
const PECA = {
  ...
  video: "newhair/limitesaque_h264.mp4",
...
const TITULO = {
  ...
  seguraAte: 3.2, // flash aos 3.45s
  saiEm: 3.45, // saída sobre o flash
};
...
const CUES: Cue[] = [
  {
    ...
    lines: [
      { text: "Nem todo enxerto RESPONDE", size: 36, gold: true },
      { text: "da mesma forma.", size: 28 },
    ],
  },
  {
    start: 6.1,
    end: 7.5,
    lines: [{ text: "RESISTÊNCIA também é informação.", size: 38, gold: true }],
  },
  {
    start: 7.7,
    end: 9.9,
    lines: [
      { text: "Na New Hair, a equipe OBSERVA, COMUNICA", size: 30, gold: true },
      { text: "e respeita o LIMITE do folículo.", size: 32, gold: true },
    ],
  },
  {
    start: 10.1,
    ...
    lines: [
      { text: "Porque técnica também é saber", size: 30 },
      { text: "A HORA DE NÃO INSISTIR.", size: 38, gold: true },
    ],
  },
];
...
export type NewHairLimiteSaqueProps = {
  durationSeconds: number;
  video: string;
};

export const NewHairLimiteSaque: React.FC<NewHairLimiteSaqueProps> = ({ video }) => {
