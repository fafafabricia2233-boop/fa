...
const PECA = {
  ...
  video: "newhair/postura_h264.mp4",
...
const CUES: Cue[] = [
  {
    ...
    lines: [{ text: "COMENTÁRIOS.", size: 46, gold: true }],
  },
  {
    start: 5.5,
    end: 6.5,
    lines: [{ text: "RECLAMAÇÕES.", size: 46, gold: true }],
  },
  {
    start: 6.5,
    end: 7.9,
    lines: [{ text: "Conversas INADEQUADAS.", size: 44, gold: true }],
  },
  {
    start: 7.9,
    end: 9.3,
    lines: [{ text: "Discussões DENTRO DA SALA.", size: 44, gold: true }],
  },
  {
    start: 9.5,
    end: 13.9,
    lines: [
      { text: "Na New Hair, POSTURA PROFISSIONAL", size: 40, gold: true },
      { text: "também faz parte do cuidado com o paciente.", size: 30 },
    ],
  },
];
...
export type NewHairPosturaProps = {
  durationSeconds: number;
  video: string;
};

export const NewHairPostura: React.FC<NewHairPosturaProps> = ({ video }) => {
