...
const PECA = {
  ...
  video: "newhair/pos_extracao_h264.mp4",
...
const TITULO = {
  linhas: [
    "MÉDICO, A EXTRAÇÃO",
    "TERMINOU. MAS O FOLÍCULO",
    "AINDA PODE SER MALTRATADO",
  ],
  ...
  seguraAte: 4.8, // corte aos 5.10s
  saiEm: 5.05, // saída sobre o corte
};
...
const CUES: Cue[] = [
  {
    ...
    lines: [{ text: "PRESSÃO EXCESSIVA.", size: 42, gold: true }],
  },
  {
    start: 6.8,
    end: 8.2,
    lines: [{ text: "MANIPULAÇÃO DESNECESSÁRIA.", size: 40, gold: true }],
  },
  {
    start: 8.4,
    end: 9.8,
    lines: [{ text: "Separação SEM DELICADEZA.", size: 42, gold: true }],
  },
  {
    start: 10.0,
    end: 11.8,
    lines: [
      { text: "Na New Hair, o CUIDADO", size: 40, gold: true },
      { text: "continua até a implantação.", size: 32 },
    ],
  },
];
...
export type NewHairPosExtracaoProps = {
  durationSeconds: number;
  video: string;
};

export const NewHairPosExtracao: React.FC<NewHairPosExtracaoProps> = ({ video }) => {
