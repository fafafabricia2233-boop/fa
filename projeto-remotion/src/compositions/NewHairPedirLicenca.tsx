...
const PECA = {
  ...
  video: "newhair/pedirlicenca_h264.mp4",
...
const TITULO = {
  linhas: [
    ...
    "PEDIR LICENÇA DENTRO",
    "DA SUA PRÓPRIA CIRURGIA?",
  ],
...
const CUES: Cue[] = [
  {
    ...
    lines: [
      { text: "Isso acontece quando a equipe deixa de apoiar", size: 28 },
      { text: "e começa a OCUPAR ESPAÇO demais.", size: 36, gold: true },
    ],
  },
  {
    start: 7.3,
    end: 8.6,
    lines: [{ text: "Na New Hair, QUEM CONDUZ é o médico.", size: 38, gold: true }],
  },
  {
    start: 8.9,
    end: 11.3,
    lines: [
      { text: "A equipe ORGANIZA, EXECUTA", size: 36, gold: true },
      { text: "e acompanha o seu fluxo.", size: 30 },
    ],
  },
  {
    start: 11.6,
    end: 14.3,
    lines: [{ text: "Sem DISPUTAR o controle da cirurgia.", size: 36, gold: true }],
  },
];
...
export type NewHairPedirLicencaProps = {
  durationSeconds: number;
  video: string;
};

export const NewHairPedirLicenca: React.FC<NewHairPedirLicencaProps> = ({ video }) => {
