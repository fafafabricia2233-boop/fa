...
const PECA = {
  ...
  video: "newhair/chamarresolver_h264.mp4",
...
const TITULO = {
  ...
  seguraAte: 2.05, // corte aos 2.30s
...
const CUES: Cue[] = [
  {
    ...
    lines: [
      { text: "Nem tudo precisa INTERROMPER", size: 34, gold: true },
      { text: "sua concentração.", size: 28 },
    ],
  },
  {
    start: 5.3,
    ...
    lines: [
      { text: "Mas algumas coisas precisam chegar", size: 28 },
      { text: "até você NA HORA CERTA.", size: 34, gold: true },
    ],
  },
  {
    start: 7.5,
    ...
    lines: [
      { text: "Na New Hair, a equipe aprende", size: 28 },
      { text: "a DIFERENCIAR uma coisa da outra.", size: 32, gold: true },
    ],
  },
  {
    start: 9.2,
    ...
    lines: [
      { text: "Porque suporte de alto nível também é", size: 26 },
      { text: "saber quando AGIR e quando COMUNICAR.", size: 30, gold: true },
    ],
  },
];
...
export type NewHairChamarResolverProps = {
  durationSeconds: number;
  video: string;
};

export const NewHairChamarResolver: React.FC<NewHairChamarResolverProps> = ({ video }) => {
