...
const PECA = {
  ...
  video: "newhair/conhecimento_h264.mp4",
...
const TITULO = {
  ...
  seguraAte: 4.2, // sem cortes neste video
  saiEm: 4.5, // saída suave
};
...
const CUES: Cue[] = [
  {
    ...
    lines: [{ text: "Tem equipe que NÃO EXPLICA.", size: 44, gold: true }],
  },
  {
    start: 6.2,
    end: 8.0,
    lines: [{ text: "Não integra. NÃO DEIXA NINGUÉM APRENDER.", size: 42, gold: true }],
  },
  {
    start: 8.2,
    end: 10.2,
    lines: [
      { text: "Na New Hair, CONHECIMENTO", size: 44, gold: true },
      { text: "não é ferramenta de PODER.", size: 34 },
    ],
  },
  {
    start: 10.4,
    end: 11.6,
    lines: [{ text: "A gente SOMA, ORIENTA", size: 44, gold: true }],
  },
  {
    start: 11.6,
    end: 13.1,
    lines: [{ text: "e respeita quem quer EVOLUIR JUNTO.", size: 42, gold: true }],
  },
];
...
export type NewHairConhecimentoProps = {
  durationSeconds: number;
  video: string;
};

export const NewHairConhecimento: React.FC<NewHairConhecimentoProps> = ({ video }) => {
