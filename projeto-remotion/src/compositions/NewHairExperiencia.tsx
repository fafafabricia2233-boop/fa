...
const PECA = {
  ...
  video: "newhair/experiencia_h264.mp4",
...
const TITULO = {
  linhas: [
    "MÉDICO, UMA EQUIPE",
    "EXPERIENTE NÃO DEVERIA",
    "CHEGAR NA SUA CIRURGIA",
  ...
  seguraAte: 4.5, // sem cortes neste video, titulo de 5 linhas — segura mais
  saiEm: 4.8,
};
...
const CUES: Cue[] = [
  {
    ...
    lines: [{ text: "Experiência de verdade também é OUVIR.", size: 36, gold: true }],
  },
  {
    start: 6.6,
    end: 7.6,
    lines: [{ text: "SE ADAPTAR.", size: 46, gold: true }],
  },
  {
    start: 7.6,
    end: 8.8,
    lines: [{ text: "Aceitar CORREÇÕES.", size: 42, gold: true }],
  },
  {
    start: 8.8,
    end: 10.2,
    lines: [{ text: "E respeitar sua forma DE OPERAR.", size: 38, gold: true }],
  },
  {
    start: 10.4,
    end: 12.0,
    lines: [
      { text: "Na New Hair, CONHECIMENTO", size: 40, gold: true },
      { text: "não vira disputa de espaço.", size: 32 },
    ],
  },
  {
    start: 12.2,
    end: 13.1,
    lines: [{ text: "VIRA SUPORTE.", size: 46, gold: true }],
  },
];
...
export type NewHairExperienciaProps = {
  durationSeconds: number;
  video: string;
};

export const NewHairExperiencia: React.FC<NewHairExperienciaProps> = ({ video }) => {
