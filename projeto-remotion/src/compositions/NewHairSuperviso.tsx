...
const PECA = {
  ...
  video: "newhair/supervisao_h264.mp4",
...
const TITULO = {
  ...
  seguraAte: 9.0, // deixar título mais tempo (cortes aos 10.7s)
  saiEm: 9.5, // saída suave antes dos cortes
};
...
const CUES: Cue[] = [
  {
    ...
    lines: [
      { text: "A equipe deve", size: 38 },
      { text: "TRAZER SUPORTE", size: 46, gold: true },
    ],
  },
  {
    start: 11.0,
    end: 12.0,
    lines: [{ text: "SEGURANÇA", size: 46, gold: true }],
  },
  {
    start: 12.0,
    end: 14.0,
    lines: [
      { text: "E previsibilidade", size: 34 },
      { text: "PARA A CIRURGIA", size: 46, gold: true },
    ],
  },
];
...
export type NewHairSupervisoProps = {
  durationSeconds: number;
  video: string;
};

export const NewHairSuperviso: React.FC<NewHairSupervisoProps> = ({ video }) => {
