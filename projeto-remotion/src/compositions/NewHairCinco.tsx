/* =============================================================================
   ...
   1. Copie este arquivo em src/compositions/ com o nome da peca.
      Ex.: NewHairGelox.tsx
   2. Troque NewHairCinco por NewHairGelox nas 3 ocorrencias do fim do arquivo
...
const PECA = {
  ...
  endCard: null as number | null,   /* MEDIDO nesta fita: nao tem end card */
...
const TITULO = {
  /* Texto dado pela dona. Fita sem fala (passo 3 devolveu alucinacao classica
     em audio sem voz), entao o titulo veio escrito, nao de gancho falado.
     Nenhuma palavra alterada. */
  linhas: [
    "5 PROBLEMAS QUE VOCÊ",
    "NORMALIZOU NA SUA CIRURGIA",
    "E NÃO DEVERIA",
  ],
  ...
  /* PERMANENTE por ordem da dona: "titulo durante o video todo".
     O template segura ate FIM-0.35 e some em FIM sozinho. */
...
const CUES: Cue[] = [
  /* VAZIO de proposito: a dona pediu os 5 problemas NA LEGENDA do post, nao
     queimados na tela. O titulo carrega o gancho e o rodape fica so com o selo. */
];
...
export type NewHairCincoProps = {
  durationSeconds: number;
  video: string;
};

export const NewHairCinco: React.FC<NewHairCincoProps> = ({ video }) => {
