...
const TITULO = {
  ...
  seguraAte: 2.4, // corte aos 2.65s
  saiEm: 2.65, // saída sobre o corte
};
...
const CUES: Cue[] = [
  {
    ...
    lines: [{ text: "Cada médico tem SUA TÉCNICA.", size: 42, gold: true }],
  },
  {
    start: 5.9,
    end: 6.9,
    lines: [{ text: "SEU FLUXO.", size: 46, gold: true }],
  },
  {
    start: 6.9,
    end: 8.1,
    lines: [{ text: "SUAS PREFERÊNCIAS.", size: 44, gold: true }],
  },
  {
    start: 8.3,
    end: 9.9,
    lines: [{ text: "Na New Hair, a equipe SE ADAPTA", size: 40, gold: true }],
  },
  {
    start: 10.9,
    end: 13.9,
    lines: [{ text: "à sua forma DE TRABALHAR.", size: 42, gold: true }],
  },
];
...
export type NewHairRitmoProps = {
  durationSeconds: number;
  video: string;
};

export const NewHairRitmo: React.FC<NewHairRitmoProps> = ({ video }) => {
