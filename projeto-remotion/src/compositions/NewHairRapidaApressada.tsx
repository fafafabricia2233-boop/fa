...
const PECA = {
  ...
  video: "newhair/rapidaapressada_h264.mp4",
...
const TITULO = {
  ...
  seguraAte: 3.1, // flash aos 3.35s
  saiEm: 3.35, // saída sobre o flash
};
...
const CUES: Cue[] = [
  {
    ...
    lines: [{ text: "Velocidade sem organização VIRA ERRO.", size: 34, gold: true }],
  },
  {
    start: 4.9,
    end: 5.3,
  ...
  },
  {
    ...
    lines: [
      ...
      { text: "antes da QUALIDADE.", size: 36, gold: true },
    ],
  },
];
...
export type NewHairRapidaApressadaProps = {
  durationSeconds: number;
  video: string;
};

export const NewHairRapidaApressada: React.FC<NewHairRapidaApressadaProps> = ({ video }) => {
