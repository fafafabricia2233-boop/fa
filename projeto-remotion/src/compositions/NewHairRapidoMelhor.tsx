...
const PECA = {
  ...
  video: "newhair/rapidomelhor_h264.mp4",
...
const TITULO = {
  ...
  seguraAte: 3.3, // corte aos 3.55s
  saiEm: 3.55, // saída sobre o corte
};
...
const CUES: Cue[] = [
  {
    ...
    lines: [
      { text: "Porque pressa pode aparecer", size: 30 },
      { text: "onde você MENOS PERCEBE.", size: 36, gold: true },
    ],
  },
  {
    start: 6.6,
    end: 7.3,
    lines: [{ text: "Na SEPARAÇÃO.", size: 42, gold: true }],
  },
  {
    start: 7.3,
    end: 8.0,
    lines: [{ text: "No CARREGAMENTO.", size: 40, gold: true }],
  },
  {
    start: 8.0,
    end: 8.7,
    lines: [{ text: "Na MANIPULAÇÃO.", size: 40, gold: true }],
  },
  {
    start: 8.7,
    end: 9.4,
    lines: [{ text: "Na IMPLANTAÇÃO.", size: 40, gold: true }],
  },
  {
    start: 9.7,
    end: 12.0,
    lines: [
      { text: "Na New Hair, VELOCIDADE", size: 36, gold: true },
      { text: "nunca vem antes do CUIDADO.", size: 32, gold: true },
    ],
  },
  {
    start: 12.3,
    ...
    lines: [
      { text: "A cirurgia precisa fluir sem fazer", size: 26 },
      { text: "o enxerto pagar pela PRESSA.", size: 32, gold: true },
    ],
  },
];
...
export type NewHairRapidoMelhorProps = {
  durationSeconds: number;
  video: string;
};

export const NewHairRapidoMelhor: React.FC<NewHairRapidoMelhorProps> = ({ video }) => {
