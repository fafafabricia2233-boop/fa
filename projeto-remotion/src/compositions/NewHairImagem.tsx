...
const TITULO = {
  ...
  seguraAte: 4.0, // flash aos 4.25s
  saiEm: 4.25, // saída sobre o flash
};
...
const CUES: Cue[] = [
  {
    ...
    lines: [{ text: "Para ele, TODO MUNDO representa o seu nome.", size: 36, gold: true }],
  },
  {
    start: 7.2,
    end: 9.4,
    lines: [{ text: "Uma resposta GROSSEIRA.", size: 42, gold: true }],
  },
  {
    start: 10.3,
    end: 11.7,
    lines: [{ text: "Uma postura INADEQUADA.", size: 42, gold: true }],
  },
  {
    start: 11.7,
    end: 13.0,
    lines: [{ text: "FALTA de atenção.", size: 44, gold: true }],
  },
  {
    start: 13.5,
    end: 16.2,
    lines: [
      { text: "Na New Hair, a equipe entende que também", size: 30 },
      { text: "está cuidando da IMAGEM da sua clínica.", size: 36, gold: true },
    ],
  },
];
...
export type NewHairImagemProps = {
  durationSeconds: number;
  video: string;
};

export const NewHairImagem: React.FC<NewHairImagemProps> = ({ video }) => {
