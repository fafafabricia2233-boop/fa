...
const PECA = {
  ...
  video: "newhair/disputar_h264.mp4",
...
const TITULO = {
  linhas: [
    "MÉDICO, VOCÊ JÁ",
    "PRECISOU DISPUTAR SUA",
    "PRÓPRIA CIRURGIA COM A EQUIPE?",
  ],
  ...
  seguraAte: 2.8, // corte aos 3.10s
  saiEm: 3.1, // saída sobre o corte
};
...
const CUES: Cue[] = [
  {
    ...
    lines: [{ text: "Equipe não define SUA CONDUTA.", size: 40, gold: true }],
  },
  {
    start: 5.0,
    end: 6.5,
    lines: [{ text: "Não impede SUA PARTICIPAÇÃO.", size: 40, gold: true }],
  },
  {
    start: 6.9,
    end: 8.7,
    lines: [{ text: "Não toma a cirurgia PARA SI.", size: 42, gold: true }],
  },
  {
    start: 9.0,
    end: 10.3,
  ...
  },
  {
    ...
    lines: [{ text: "A equipe entra para APOIAR, EXECUTAR E FACILITAR.", size: 38, gold: true }],
  },
];
...
export type NewHairDisputarProps = {
  durationSeconds: number;
  video: string;
};

export const NewHairDisputar: React.FC<NewHairDisputarProps> = ({ video }) => {
