...
const TITULO = {
  ...
  seguraAte: 5.2, // corte/flash aos 5.45s
  saiEm: 5.45, // saída sobre o flash
};
...
const CUES: Cue[] = [
  {
    ...
    lines: [{ text: "Primeiro ela ENTENDE.", size: 44, gold: true }],
  },
  {
    start: 7.2,
    end: 8.2,
    lines: [{ text: "OBSERVA.", size: 48, gold: true }],
  },
  {
    start: 8.2,
    end: 9.4,
    lines: [{ text: "SE ADAPTA.", size: 46, gold: true }],
  },
  {
    start: 9.7,
    end: 12.0,
    lines: [
      { text: "Na New Hair, a gente entra para", size: 32 },
      { text: "SOMAR ao que já funciona", size: 40, gold: true },
    ],
  },
  {
    start: 12.2,
    end: 16.7,
    lines: [{ text: "e ORGANIZAR o que precisa melhorar.", size: 40, gold: true }],
  },
];
...
export type NewHairSomarProps = {
  durationSeconds: number;
  video: string;
};

export const NewHairSomar: React.FC<NewHairSomarProps> = ({ video }) => {
