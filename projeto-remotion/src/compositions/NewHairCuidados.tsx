...
const PECA = {
  ...
  video: "newhair/cuidados_h264.mp4",
...
const TITULO = {
  linhas: [
    "MÉDICO, O PACIENTE",
    "PODE ESQUECER",
    "MAS NÃO ESQUECE COMO FOI TRATADO",
  ],
  ...
  seguraAte: 2.8, // cortes aos 3.15s
  saiEm: 3.0, // saída antes dos cortes
};
...
const CUES: Cue[] = [
  {
    ...
    lines: [{ text: "Receber pelo NOME", size: 46, gold: true }],
  },
  {
    start: 5.2,
    end: 7.4,
    lines: [{ text: "Perguntar como ELE ESTÁ", size: 46, gold: true }],
  },
  {
    start: 7.6,
    end: 9.5,
    lines: [{ text: "Explicar o QUE VAI ACONTECER", size: 46, gold: true }],
  },
  {
    start: 9.9,
    end: 12.2,
    lines: [
      { text: "Pequenos cuidados fazem ele perceber", size: 34 },
      { text: "QUE NÃO É SÓ MAIS UM", size: 46, gold: true },
    ],
  },
];
...
export type NewHairCuidadosProps = {
  durationSeconds: number;
  video: string;
};

export const NewHairCuidados: React.FC<NewHairCuidadosProps> = ({ video }) => {
