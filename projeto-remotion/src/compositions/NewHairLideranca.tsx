...
const PECA = {
  ...
  video: "newhair/lideranca_h264.mp4",
...
const TITULO = {
  ...
  seguraAte: 3.5, // sem cortes neste video
  saiEm: 3.8, // saída antes do end card
};
...
const CUES: Cue[] = [
  {
    ...
    lines: [{ text: "Sua equipe está ali para APOIAR", size: 46, gold: true }],
  },
  {
    start: 5.8,
    end: 7.2,
    lines: [{ text: "Não para DECIDIR por você", size: 46, gold: true }],
  },
  {
    start: 7.2,
    end: 8.6,
    lines: [{ text: "Não para IMPOR condutas", size: 46, gold: true }],
  },
  {
    start: 8.6,
    end: 10.5,
    lines: [
      { text: "A liderança médica é", size: 34 },
      { text: "RESPEITADA", size: 46, gold: true },
    ],
  },
];
...
export type NewHairLiderancaProps = {
  durationSeconds: number;
  video: string;
};

export const NewHairLideranca: React.FC<NewHairLiderancaProps> = ({ video }) => {
