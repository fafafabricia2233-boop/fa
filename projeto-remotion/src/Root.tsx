...
import { NewHairExtracao, type NewHairExtracaoProps } from "./compositions/NewHairExtracao";
import { NewHairFlui3, type NewHairFlui3Props } from "./compositions/NewHairFlui3";
import { NewHairFlui4, type NewHairFlui4Props } from "./compositions/NewHairFlui4";
import { NewHairMaturidade, type NewHairMaturidadeProps } from "./compositions/NewHairMaturidade";
import { NewHairSuperviso, type NewHairSupervisoProps } from "./compositions/NewHairSuperviso";
import { NewHairProtocolo, type NewHairProtocoloProps } from "./compositions/NewHairProtocolo";
import { NewHairHistoria, type NewHairHistoriaProps } from "./compositions/NewHairHistoria";
import { NewHairExcelencia, type NewHairExcelenciaProps } from "./compositions/NewHairExcelencia";
import { NewHairCuidados, type NewHairCuidadosProps } from "./compositions/NewHairCuidados";
import { NewHairLideranca, type NewHairLiderancaProps } from "./compositions/NewHairLideranca";
import { NewHairFoliculo, type NewHairFoliculoProps } from "./compositions/NewHairFoliculo";
import { NewHairAtendimento, type NewHairAtendimentoProps } from "./compositions/NewHairAtendimento";
import { NewHairFluxo, type NewHairFluxoProps } from "./compositions/NewHairFluxo";
import { NewHairConhecimento, type NewHairConhecimentoProps } from "./compositions/NewHairConhecimento";
...
import { NewHairAnsioso, type NewHairAnsiosoProps } from "./compositions/NewHairAnsioso";
import { NewHairSuporte2, type NewHairSuporte2Props } from "./compositions/NewHairSuporte2";
...
import { NewHairPreparo, type NewHairPreparoProps } from "./compositions/NewHairPreparo";
  ...
  return (
    <>
      ...
      <Folder name="REELS">
        ...
        <Folder name="NewHair-Flui4">
          <Composition
            id="NewHairFlui4"
            component={NewHairFlui4 as React.FC<NewHairFlui4Props>}
            width={1080}
            height={1920}
            fps={30}
            durationInFrames={Math.round(15.4 * 30)}
            defaultProps={{ durationSeconds: 15.4, video: "newhair/flui4_h264.mp4" }}
          />
        </Folder>

        <Folder name="NewHair-Flui3">
          <Composition
            id="NewHairFlui3"
            component={NewHairFlui3 as React.FC<NewHairFlui3Props>}
            width={1080}
            height={1920}
            fps={30}
            durationInFrames={Math.round(17.8 * 30)}
            defaultProps={{ durationSeconds: 17.8, video: "newhair/flui2_h264.mp4" }}
          />
        </Folder>

        <Folder name="NewHair-Extracao">
          <Composition
            id="NewHairExtracao"
            component={NewHairExtracao as React.FC<NewHairExtracaoProps>}
            width={1080}
            height={1920}
            fps={30}
            durationInFrames={Math.round(13.234 * 30)}
            defaultProps={{ durationSeconds: 13.234, video: "newhair/extracao_h264.mp4" }}
          />
        </Folder>
        ...
        <Folder name="NewHair-Maturidade">
          <Composition
            id="NewHairMaturidade"
            component={NewHairMaturidade as React.FC<NewHairMaturidadeProps>}
            width={1080}
            height={1920}
            fps={30}
            durationInFrames={Math.round(16.867 * 30)}
            defaultProps={{ durationSeconds: 16.867, video: "newhair/maturidade_h264.mp4" }}
          />
        </Folder>

        <Folder name="NewHair-Superviso">
          <Composition
            id="NewHairSuperviso"
            component={NewHairSuperviso as React.FC<NewHairSupervisoProps>}
            width={1080}
            height={1920}
            fps={30}
            durationInFrames={Math.round(14.488 * 30)}
            defaultProps={{ durationSeconds: 14.488, video: "newhair/supervisao_h264.mp4" }}
          />
        </Folder>

        <Folder name="NewHair-Protocolo">
          <Composition
            id="NewHairProtocolo"
            component={NewHairProtocolo as React.FC<NewHairProtocoloProps>}
            width={1080}
            height={1920}
            fps={30}
            durationInFrames={Math.round(15.9 * 30)}
            defaultProps={{ durationSeconds: 15.9, video: "newhair/protocolo_h264.mp4" }}
          />
        </Folder>

        <Folder name="NewHair-Historia">
          <Composition
            id="NewHairHistoria"
            component={NewHairHistoria as React.FC<NewHairHistoriaProps>}
            width={1080}
            height={1920}
            fps={30}
            durationInFrames={Math.round(12.978 * 30)}
            defaultProps={{ durationSeconds: 12.978, video: "newhair/historia_h264.mp4" }}
          />
        </Folder>

        <Folder name="NewHair-Excelencia">
          <Composition
            id="NewHairExcelencia"
            component={NewHairExcelencia as React.FC<NewHairExcelenciaProps>}
            width={1080}
            height={1920}
            fps={30}
            durationInFrames={Math.round(13.907 * 30)}
            defaultProps={{ durationSeconds: 13.907, video: "newhair/excelencia_h264.mp4" }}
          />
        </Folder>

        <Folder name="NewHair-Cuidados">
          <Composition
            id="NewHairCuidados"
            component={NewHairCuidados as React.FC<NewHairCuidadosProps>}
            width={1080}
            height={1920}
            fps={30}
            durationInFrames={Math.round(12.305 * 30)}
            defaultProps={{ durationSeconds: 12.305, video: "newhair/cuidados_h264.mp4" }}
          />
        </Folder>

        <Folder name="NewHair-Lideranca">
          <Composition
            id="NewHairLideranca"
            component={NewHairLideranca as React.FC<NewHairLiderancaProps>}
            width={1080}
            height={1920}
            fps={30}
            durationInFrames={Math.round(11.214 * 30)}
            defaultProps={{ durationSeconds: 11.214, video: "newhair/lideranca_h264.mp4" }}
          />
        </Folder>

        <Folder name="NewHair-Foliculo">
          <Composition
            id="NewHairFoliculo"
            component={NewHairFoliculo as React.FC<NewHairFoliculoProps>}
            width={1080}
            height={1920}
            fps={30}
            durationInFrames={Math.round(15.3 * 30)}
            defaultProps={{ durationSeconds: 15.3, video: "newhair/foliaculo_h264.mp4" }}
          />
        </Folder>

        <Folder name="NewHair-Atendimento">
          <Composition
            id="NewHairAtendimento"
            component={NewHairAtendimento as React.FC<NewHairAtendimentoProps>}
            width={1080}
            height={1920}
            fps={30}
            durationInFrames={Math.round(11.1 * 30)}
            defaultProps={{ durationSeconds: 11.1, video: "newhair/tecnica_h264.mp4" }}
          />
        </Folder>

        <Folder name="NewHair-Fluxo">
          <Composition
            id="NewHairFluxo"
            component={NewHairFluxo as React.FC<NewHairFluxoProps>}
            width={1080}
            height={1920}
            fps={30}
            durationInFrames={Math.round(15.0 * 30)}
            defaultProps={{ durationSeconds: 15.0, video: "newhair/fluxo_h264.mp4" }}
          />
        </Folder>

        <Folder name="NewHair-Conhecimento">
          <Composition
            id="NewHairConhecimento"
            component={NewHairConhecimento as React.FC<NewHairConhecimentoProps>}
            width={1080}
            height={1920}
            fps={30}
            durationInFrames={Math.round(13.167 * 30)}
            defaultProps={{ durationSeconds: 13.167, video: "newhair/conhecimento_h264.mp4" }}
          />
        </Folder>

        <Folder name="NewHair-Organizacao">
          <Composition
            id="NewHairOrganizacao"
            component={NewHairOrganizacao as React.FC<NewHairOrganizacaoProps>}
            width={1080}
            height={1920}
            fps={30}
            durationInFrames={Math.round(13.733 * 30)}
            defaultProps={{ durationSeconds: 13.733, video: "newhair/organizacao_h264.mp4" }}
          />
        </Folder>

        <Folder name="NewHair-Dependencia">
          <Composition
            id="NewHairDependencia"
            component={NewHairDependencia as React.FC<NewHairDependenciaProps>}
            width={1080}
            height={1920}
            fps={30}
            durationInFrames={Math.round(13.167 * 30)}
            defaultProps={{ durationSeconds: 13.167, video: "newhair/dependencia_h264.mp4" }}
          />
        </Folder>

        <Folder name="NewHair-Pressao">
          <Composition
            id="NewHairPressao"
            component={NewHairPressao as React.FC<NewHairPressaoProps>}
            width={1080}
            height={1920}
            fps={30}
        ...
        <Folder name="NewHair-Protocolo2">
          <Composition
            id="NewHairProtocolo2"
            component={NewHairProtocolo2 as React.FC<NewHairProtocolo2Props>}
            width={1080}
            height={1920}
            fps={30}
            durationInFrames={Math.round(17.483 * 30)}
            defaultProps={{ durationSeconds: 17.483, video: "newhair/protocolo2_h264.mp4" }}
          />
        </Folder>

        <Folder name="NewHair-Registro">
          <Composition
            id="NewHairRegistro"
            component={NewHairRegistro as React.FC<NewHairRegistroProps>}
            width={1080}
            height={1920}
            fps={30}
            durationInFrames={Math.round(13.733 * 30)}
        ...
        <Folder name="NewHair-PosExtracao">
          <Composition
            id="NewHairPosExtracao"
            component={NewHairPosExtracao as React.FC<NewHairPosExtracaoProps>}
            width={1080}
            height={1920}
            fps={30}
            durationInFrames={Math.round(12.533 * 30)}
            defaultProps={{ durationSeconds: 12.533, video: "newhair/pos_extracao_h264.mp4" }}
          />
        </Folder>

        <Folder name="NewHair-Ritmo">
          <Composition
            id="NewHairRitmo"
            component={NewHairRitmo as React.FC<NewHairRitmoProps>}
            width={1080}
            height={1920}
            fps={30}
        ...
        <Folder name="NewHair-Antecipar">
          <Composition
            id="NewHairAntecipar"
            component={NewHairAntecipar as React.FC<NewHairAnteciparProps>}
            width={1080}
            height={1920}
            fps={30}
        ...
        <Folder name="NewHair-Ansioso">
          <Composition
            id="NewHairAnsioso"
            component={NewHairAnsioso as React.FC<NewHairAnsiosoProps>}
            width={1080}
            height={1920}
            fps={30}
            durationInFrames={Math.round(11.539 * 30)}
            defaultProps={{ durationSeconds: 11.539, video: "newhair/ansioso_h264.mp4" }}
          />
        </Folder>

        <Folder name="NewHair-Suporte2">
          <Composition
            id="NewHairSuporte2"
            component={NewHairSuporte2 as React.FC<NewHairSuporte2Props>}
            width={1080}
            height={1920}
            fps={30}
            durationInFrames={Math.round(11.539 * 30)}
            defaultProps={{ durationSeconds: 11.539, video: "newhair/suporte2_h264.mp4" }}
          />
        </Folder>

        <Folder name="NewHair-Experiencia">
          <Composition
            id="NewHairExperiencia"
            component={NewHairExperiencia as React.FC<NewHairExperienciaProps>}
            width={1080}
            height={1920}
            fps={30}
            durationInFrames={Math.round(13.167 * 30)}
            defaultProps={{ durationSeconds: 13.167, video: "newhair/experiencia_h264.mp4" }}
          />
        </Folder>

        <Folder name="NewHair-BasicoPadrao">
          <Composition
            id="NewHairBasicoPadrao"
            component={NewHairBasicoPadrao as React.FC<NewHairBasicoPadraoProps>}
            width={1080}
            height={1920}
            fps={30}
            durationInFrames={Math.round(16.933 * 30)}
            defaultProps={{ durationSeconds: 16.933, video: "newhair/basicopadrao_h264.mp4" }}
          />
        </Folder>

        <Folder name="NewHair-Imagem">
          <Composition
            id="NewHairImagem"
            component={NewHairImagem as React.FC<NewHairImagemProps>}
            width={1080}
            height={1920}
            fps={30}
        ...
        <Folder name="NewHair-RitmoCirurgiao">
          <Composition
            id="NewHairRitmoCirurgiao"
            component={NewHairRitmoCirurgiao as React.FC<NewHairRitmoCirurgiaoProps>}
            width={1080}
            height={1920}
            fps={30}
        ...
        <Folder name="NewHair-PadraoSeguir">
          <Composition
            id="NewHairPadraoSeguir"
            component={ReelFalado}
            width={1080}
            height={1920}
            fps={PLANO_PADRAO_SEGUIR.fps}
            durationInFrames={PLANO_PADRAO_SEGUIR.duration}
            defaultProps={{ marca: "newhair", plano: PLANO_PADRAO_SEGUIR, cues: CUES_PADRAO_SEGUIR }}
          />
        </Folder>
        ...
        <Folder name="NewHair-Antecipa">
          <Composition
            ...
            width={1080}
            height={1920}
            fps={PLANO_ANTECIPA.fps}
            durationInFrames={PLANO_ANTECIPA.duration}
            defaultProps={{ marca: "newhair", plano: PLANO_ANTECIPA, cues: CUES_ANTECIPA }}
          />
        </Folder>

        <Folder name="NewHair-Saque">
          <Composition
            id="NewHairSaque"
            component={ReelFalado}
            width={1080}
            height={1920}
            fps={PLANO_SAQUE.fps}
            durationInFrames={PLANO_SAQUE.duration}
            defaultProps={{ marca: "newhair", plano: PLANO_SAQUE, cues: CUES_SAQUE }}
          />
        </Folder>
        ...
        <Folder name="NewHair-Eficiencia">
          <Composition
            id="NewHairEficiencia"
            component={NewHairEficiencia as React.FC<NewHairEficienciaProps>}
            width={1080}
            height={1920}
            fps={30}
            durationInFrames={Math.round(16.067 * 30)}
            defaultProps={{ durationSeconds: 16.067, video: "newhair/eficiencia_h264.mp4" }}
          />
        </Folder>

        <Folder name="NewHair-Conferencia">
          <Composition
            id="NewHairConferencia"
            component={NewHairConferencia as React.FC<NewHairConferenciaProps>}
            width={1080}
            height={1920}
            fps={30}
            durationInFrames={Math.round(14.6 * 30)}
            defaultProps={{ durationSeconds: 14.6, video: "newhair/conferencia_h264.mp4" }}
          />
        </Folder>

        <Folder name="NewHair-Funcoes">
          <Composition
            id="NewHairFuncoes"
            component={NewHairFuncoes as React.FC<NewHairFuncoesProps>}
            width={1080}
            height={1920}
            fps={30}
            durationInFrames={Math.round(11.433 * 30)}
            defaultProps={{ durationSeconds: 11.433, video: "newhair/funcoes_h264.mp4" }}
          />
        </Folder>

        <Folder name="NewHair-Preparo">
          <Composition
            id="NewHairPreparo"
            component={NewHairPreparo as React.FC<NewHairPreparoProps>}
            width={1080}
            height={1920}
            fps={30}
            durationInFrames={Math.round(17.033 * 30)}
            defaultProps={{ durationSeconds: 17.033, video: "newhair/preparo_h264.mp4" }}
          />
        </Folder>
        ...
        <Folder name="NewHair-MudaRumo">
          <Composition
            id="NewHairMudaRumo"
            component={NewHairMudaRumo as React.FC<NewHairMudaRumoProps>}
            width={1080}
            height={1920}
            fps={30}
            durationInFrames={Math.round(13.814 * 30)}
            defaultProps={{ durationSeconds: 13.814, video: "newhair/mudarumo_h264.mp4" }}
          />
        </Folder>
